...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        PaginatedRepository<Tuple<User, User>, Friendship> friendshipRepository = new FriendshipDbRepository("jdbc:postgresql://localhost:5432/SocialNetwork", "postgres", "postgres");
